...
public class EffectorControll {
  ...
  public EffectorControll(
      UserEffectors userEffector, LocalDateTime controllActivationMoment, float effectorValue) {
  ...
  public int hashCode() {
    return Objects.hash(
        this.effectorControllId,
        this.userEffector,
        this.controllActivationMoment,
        this.effectorValue);
  }

  public boolean equals(Object comparedObject) {
    if (this == comparedObject) return true;
    if (comparedObject == null || comparedObject.getClass() != EffectorControll.class) return false;
    ...
    return effectorControllId == comparedEffectorControll.effectorControllId
        ...
        && Objects.equals(
            controllActivationMoment, comparedEffectorControll.controllActivationMoment)
