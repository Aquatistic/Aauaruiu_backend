...
public class UserEffectors {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(userEffectorTypeId, effectorType, aquarium, effectorValue, effectorControlType);
    }
    ...
    public boolean equals(Object comparedObject) {
        if (this == comparedObject)
            return true;
        if (comparedObject == null || comparedObject.getClass() != UserEffectors.class)
            return false;
