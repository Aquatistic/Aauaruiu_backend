...
public class UserEffectorsControllerTest {
  @Autowired UserEffectorController userEffectorController;

  @MockBean UserEffectorService userEffectorService;
  ...
  void getEffectorsByAquariumId() {
    ...
    when(userEffectorService.getUserEffectorsByAquariumId(aquarium.getAquariumId()))
        .thenReturn(expectedEffectors);
    ResponseEntity<List<UserEffectors>> effectorsList =
        userEffectorController.getEffectorsByAquariumId(aquarium.getAquariumId());
