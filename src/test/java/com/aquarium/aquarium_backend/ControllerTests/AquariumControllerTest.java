...
public class AquariumControllerTest {
  @Autowired AquariumController aquariumController;

  @MockBean AquariumService aquariumService;
  ...
  void getAllUsersAquariumsEmptyAquariumAndUsers() throws Exception {
    ...
    assertThat(aquariumController.getAquariumByUserId(1L))
        .isEqualTo(new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST));
  }
  ...
  void getAllUsersAquariumsNonEmpty() throws Exception {
    ...
    assertThat(aquariumController.getAquariumByUserId(userId))
        .isEqualTo(new ResponseEntity<>(expectedAquariums, HttpStatus.OK));
  }
}
