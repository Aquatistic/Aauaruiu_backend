...
public class UserEffectorsServiceTest {
  @Autowired UserEffectorService userEffectorService;
  @MockBean UserEffectorRepository userEffectorRepository;
  ...
  void getEffectorsByAquariumId() {
    ...
    when(userEffectorRepository.findUserEffectorsByAquariumId(aquarium.getAquariumId()))
        .thenReturn(expectedEffectors);
    List<UserEffectors> effectorsList =
        userEffectorService.getUserEffectorsByAquariumId(aquarium.getAquariumId());
