...
public class AquariumServiceTest {
  @Autowired AquariumService aquariumService;

  @MockBean AquariumRepository aquariumRepository;
  ...
  void getAllUsersAquariumsEmptyAquariumAndUsers() {
    ...
    Exception exception =
        assertThrows(Exception.class, () -> aquariumService.getAllUsersAquariums(1L));
